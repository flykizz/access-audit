...
function Signup() {
  ...
  const isValid = formData.name && formData.email && formData.password && agreeTerms;
      ...
      <Grid container height="100vh">
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            >
              Get $3 free credits to start testing with AI
            </Typography>
            ...
            <form onSubmit={handleSubmit}>
              <Button
                ...
                onClick={() => window.location.href = `${process.env.REACT_APP_API_URL || 'http://localhost:3000'}/auth/google`}
              >
              ...
              <Button
                ...
                onClick={() => window.location.href = `${process.env.REACT_APP_API_URL || 'http://localhost:3000'}/auth/github`}
              >
              ...
              >
                Email signup requires verification to receive $3 credits
              </Typography>
