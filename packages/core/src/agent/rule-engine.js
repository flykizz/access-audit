export class RuleEngine {
    ...
    async checkKeyboardReachability(target) {
    ...
    async checkKeyboardTrap(target) {
    ...
    async checkFocusVisibility(target) {
    ...
    async checkModalFocusReturn(target) {
        const result = await this.page.evaluate((selector) => {
